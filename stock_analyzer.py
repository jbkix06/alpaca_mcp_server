...
def run(args):
    ...
    for symbol in universe:
        try:
            ...
            trade_time = datetime.fromisoformat(snapshot['latestTrade']['t'].replace('Z', '+00:00')).astimezone(ZoneInfo("America/New_York"))
    ...
    try:
        ...
        os.system('scp -q latest.html stockminer@www.stockminer.net:/home/71/00/8200071/public_html/latest/index.html')
